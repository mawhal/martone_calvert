...
## The purpose of this script is to identify the 14-day artifact and see if it can be removed through averaging or some other strategy
...
write_csv( dm, "output from R/PineIsland_monthly_SST_anomaly.csv" )
