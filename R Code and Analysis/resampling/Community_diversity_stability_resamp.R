...
mkept <- muse %>% filter( Quadrat %in% kept )
muse <- mkept
...
stab
ggsave( paste0("R Code and Analysis/Figs/stability_richness_algae_resamp_",seed,"_keep",nkeep,".svg"),width = 3, height=4 )
...
dsynch$Site <- factor( dsynch$Site, levels = c("West Beach", "Fifth Beach", "North Beach" ))
...
ggsave( paste0("R Code and Analysis/Figs/stability+resist_resil_synch_",seed,"_keep",nkeep,".svg"), width=6, height=10 )
